...
class NEAlbumListViewController: UITableViewController {
    ...
    private func loadAlbumData(){
        do {
            try NEAPIManager.getDataUsingRequest(urlString: RSS_URL, completion: { (response) in
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        let detailVC = NEAlbumDetailViewController()
